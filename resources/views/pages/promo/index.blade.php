...
<nav>
  ...
  <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
    ...
    <li class="text-size-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">Promo Product</li>
  </ol>
  <h6 class="mb-0 font-bold capitalize">Promo Produk</h6>
</nav>
  ...
  <div class="flex-none w-full max-w-full px-3">
    <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
      <div class="flex justify-between p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
        <h6>Tabel Promo</h6>
        <a href="{{ route('promo-web.create') }}">Create</a>
      </div>
          ...
          <table class="items-center justify-center w-full mb-0 align-top border-gray-200 text-slate-500">
            <thead class="align-bottom">
              <tr>
                ...
                <th class="px-6 py-3 pl-2 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-size-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Discount</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                  <p class="mb-0 font-semibold leading-normal text-size-sm">{{ $data->discount }}</p>
                </td>
              
                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                  <div class="flex justify-center px-2">
                    <a href="{{ route('promo-web.edit',["promo" =>$data->id]) }}" class="mr-4">
                    ...
                    <form action="{{ route('promo-web.destroy',["promo" =>$data->id]) }}" method="POST" enctype='multipart/form-data'>
                      @csrf
                      @method("DELETE")

  ...
  <div class="flex-none w-full max-w-full px-3">
    <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
      <div class="flex justify-between p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
        <h6>Tabel Produk</h6>
        <a href="{{ route('product-category-web.create') }}">Create</a>
      </div>
              ...
              <tr>
                ...
                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                  <div class="flex justify-center px-2">
                    <a href="{{ route('product-category-web.edit',["product_category" =>$data->id]) }}" class="mr-4">
                    ...
                    <form action="{{ route('product-category-web.destroy',["product_category" =>$data->id]) }}" method="POST" enctype='multipart/form-data'>
                      @csrf
                      @method("DELETE")
